...
# 1.- Implementar una tarea MapReduce en mrjob que resuelva este problema utilizando únicamente las fases mapper
# y reducer
...
# 2.-  Implementar una tarea MapReduce en mrjob que resuelva este problema utilizando las fases mapper y reducer,
